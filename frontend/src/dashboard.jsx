...
const fetchApi = async (endpoint, method = 'GET', body = null) => {
  ...
  // Fallback to localhost if Vite environment variables aren't injected
  ...
  const loadData = async () => {
    try {
      ...
      try {
        ...
        // Fallback mock data for visual UI compilation when API is unreachable
  ...
  const loadData = async () => {
    try {
      ...
      try {
        ...
        // Fallback mock data for visual UI compilation
        setCourses([
